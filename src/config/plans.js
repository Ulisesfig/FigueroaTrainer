export const plans = [
    {
        ...
        longDesc: 'El Plan Inicial está enfocado en construir bases sólidas: técnica correcta, hábitos saludables y una progresión segura para evitar lesiones y mejorar tu confianza en el entrenamiento.',
        includes: [
    ...
    },
    {
        ...
        longDesc: 'El Plan Progreso apunta a mejorar fuerza, rendimiento y composición corporal con un seguimiento más cercano y ajustes semanales basados en métricas y sensaciones.',
        includes: [
            'Plan 4x por semana',
            'Ajustes semanales',
    ...
    },
    {
        ...
        longDesc: 'El Plan Élite es para quienes buscan un rendimiento superior. Incluye mayor frecuencia, análisis avanzado de métricas y prioridad de respuesta para optimizar cada detalle.',
        includes: [
            '5-6x por semana',
